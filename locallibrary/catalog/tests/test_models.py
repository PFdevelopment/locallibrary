...
from locallibrary.catalog.models import Author, Genre
"""
class YourTestClass(TestCase):
    ...
    def setUp(self):
        print("setUp: Run once for every test method to setup cleaned data.")
        pass
...
class GenreModelTest(TestCase):
    ...
    @classmethod
    def setUpTestData(cls):
        genre = Genre.objects.create(name='History')
