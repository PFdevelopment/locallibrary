...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        resp = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}), {'due_back':valid_date_in_future} )
        self.assertRedirects(resp, reverse('catalog:borrowed') )

    def test_form_invalid_renewal_date_past(self):
        login = self.client.login(username='testuser2', password='12345')
        date_in_past = datetime.date.today() - datetime.timedelta(weeks=1)
        resp = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}), {'due_back':date_in_past} )
        self.assertEqual( resp.status_code,200)
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        resp = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}), {'due_back':invalid_date_in_future} )
        self.assertEqual( resp.status_code,200)
